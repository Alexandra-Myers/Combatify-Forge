...
public class AttributesMixin {
	...
	private static Attribute registrySet(int RawId, String id, Attribute attribute) {
		Holder<Attribute> attributeHolder = ((WritableRegistry) BuiltInRegistries.ATTRIBUTE).registerMapping(RawId, ResourceKey.create(BuiltInRegistries.ATTRIBUTE.key(), new ResourceLocation(id)), attribute, Lifecycle.stable());
